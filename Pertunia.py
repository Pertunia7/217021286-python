...
###########################################
#
# Student name: P Mthunywa
# Student no: 217021286
# Date: 
# Assignment 3: Python
#
...
print("Unique values as a set:", unique_values)
###############
...
my_dog= "Hello my dog's name is {} and he looks {} years old".format(name,age)
print(my_dog)
